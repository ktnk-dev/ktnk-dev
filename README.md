...
# Обо мне
- Я фрилансер, основной язык: `Python`
...
### Другое
- `Linux`, `AWS`, `git`, `github`

<br>

> [!WARNING]
> **Поддержка кода всех проектов временно прекращена** <br>
> Это не касается документации и критически важных баг-фиксов
